...
namespace MercanciasJyC.Controllers
{
    ...
    public class PedidosController : ControllerBase
    {
        ...
        {
            return await _context.Pedidos.Include(p => p.Cliente).Include(p => p.Entrega).ToListAsync();
        }
        ...
        {
            var pedido = await _context.Pedidos.Include(p => p.Cliente).Include(p => p.Entrega)
